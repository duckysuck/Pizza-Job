...
Config.Locales = {
	['EndJob'] = 'Bạn đã trả lại xe và nhận lại ~g~5000$~s~ tiền cọc',
	...
	['EnterVehicle'] = '<FONT FACE="Oswald">Bạn đã cọc ~g~5000$~s~ để lấy chiếc xe giao bánh ~b~Faggio~s~',
	['NotFoundLocation'] = 'Não foi encontrado localização ~b~segura~w~ para sua moto, tente novamente',
	['SearchLocation'] = '<FONT FACE="Oswald">Đang tìm vị trí giao bánh...',
	['LoadingVehicle'] = 'Carregando veículo...',
	['PressEndJob'] = '<FONT FACE="Oswald">Nhấn [~g~E~s~] để trả lại xe',
	['StartJob'] = '<FONT FACE="Oswald">Nhấn [~g~E~s~] để bắt đầu giao bánh',
	['IsWorking'] = '<FONT FACE="Oswald">Bạn đang có một ~y~Công Việc',
}
